...
-(void)addLeftGestures {
    if (_leftViewController != nil) {
        if (self.leftPanGesture == nil) {
            self.leftPanGesture = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:self action:@selector(handleLeftPanGesture:)];
             self.leftPanGesture.edges = UIRectEdgeLeft;
...
-(void)removeLeftGestures {
    if (self.leftPanGesture != nil) {
        ...
        [self.view removeGestureRecognizer:self.CloseLeftGesture];
...
-(void)handleLeftPanGesture:(UIScreenEdgePanGestureRecognizer *)panGesture {
...
-(void)openLeftWithVelocity:(CGFloat)velocity {
    ...
    [UIView animateWithDuration:duration delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        [self.view removeGestureRecognizer: self.leftPanGesture ];
        self.leftPanGesture.delegate=nil;
        [self.view removeGestureRecognizer:self.CloseLeftGesture];
        //    [self.view removeGestureRecognizer: self.leftPanGesture ];
        self.CloseLeftGesture =nil;
        self.CloseLeftGesture =[[UIPanGestureRecognizer alloc]initWithTarget:self action:@selector(handleLeftPanGesture:)];
        
        self.CloseLeftGesture.delegate = self;
        [self.view addGestureRecognizer:self.CloseLeftGesture];
...
//    [self.CloseLeftGesture removeTarget:self action:@selector(handleLeftPanGesture:)];
